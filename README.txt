...
#    Updated: 2019/10/12 13:09:26 by tgouedar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
Any set of matching single parentheses is evaluated recursively by the module
as a nested expression which result is reinjected in the main expression. Users
of this module doesn't worry about treating/sectionning nested expressions.
...
o> Value too great for base: In a given base of n length, the base digits are
	the first n symbols of the following base_sequence:
	"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@_". If one
	of the number digit's rank in the base_sequence exceeds n, or if the symbol
	isn't in the sequence at all, this error is thrown.
	If n is inferior or equal to 36 (i.e. upper case alphabet is not used in
	your base) ; upper case letters are interpreted as their lower case
	counterpart.
o> Invalid arithmetic base: a base length must be set between 2 (Dude really ?
	...
	any more ! 64 is already a stretch...) since we only utilize 64 symbols tops
	for any given base.
